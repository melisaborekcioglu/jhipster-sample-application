...
public class MailServiceIT {
    ...
    public void testSendEmailFromTemplate() throws Exception {
        ...
        userLogin.setLogin("john");
        userLogin.setEmail("john.doe@example.com");
        userLogin.setLangKey("en");
        mailService.sendEmailFromTemplate(userLogin, "mail/testEmail", "email.test.title");
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        assertThat(message.getSubject()).isEqualTo("test title");
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo(userLogin.getEmail());
        assertThat(message.getFrom()[0].toString()).isEqualTo(jHipsterProperties.getMail().getFrom());
    ...
    public void testSendActivationEmail() throws Exception {
        UserLogin userLogin = new UserLogin();
        userLogin.setLangKey(Constants.DEFAULT_LANGUAGE);
        userLogin.setLogin("john");
        userLogin.setEmail("john.doe@example.com");
        mailService.sendActivationEmail(userLogin);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo(userLogin.getEmail());
        assertThat(message.getFrom()[0].toString()).isEqualTo(jHipsterProperties.getMail().getFrom());
    ...
    public void testCreationEmail() throws Exception {
        ...
        userLogin.setLogin("john");
        userLogin.setEmail("john.doe@example.com");
        mailService.sendCreationEmail(userLogin);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo(userLogin.getEmail());
        assertThat(message.getFrom()[0].toString()).isEqualTo(jHipsterProperties.getMail().getFrom());
    ...
    public void testSendPasswordResetMail() throws Exception {
        ...
        userLogin.setLogin("john");
        userLogin.setEmail("john.doe@example.com");
        mailService.sendPasswordResetMail(userLogin);
        verify(javaMailSender).send(messageCaptor.capture());
        MimeMessage message = messageCaptor.getValue();
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo(userLogin.getEmail());
        assertThat(message.getFrom()[0].toString()).isEqualTo(jHipsterProperties.getMail().getFrom());
